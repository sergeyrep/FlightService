...
//  let success: Bool
//  let currency: String
//  let flightData: [String: [String: FlightData]]
//  
//  func convertToFlights(origin: String) -> [Flight] {
//    var flights: [Flight] = []
//    let dateFormatter = ISO8601DateFormatter()
//    dateFormatter.timeZone = TimeZone(identifier: "Europe/Moscow")
//    
//    for (destination, flightsDict) in flightData {
//      for (_, flightData) in flightsDict {
//        guard let departureTime = dateFormatter.date(from: flightData.departureAt) else { continue }
//        let returnTime = flightData.returnAt.flatMap { dateFormatter.date(from: $0) }
//        
...
////    case price
////    case airline
////    case flightNumber = "filght_number"
////    case departureAt = "departure_at"
////    case returnAt = "return_at"
////    case expiresAt = "expires_at"
////  }
...
//  var allFlight: [FlightData] {
//    flightData.flatMap { (destination, flightDict) in
//      flightDict.map { (key, flight) in
//        flight
//      }
//    }
//  }
